    ...
    let service = text
     if(text.includes("get started")){
       ...
       axios.get(`https://graph.facebook.com/${sender}?fields=first_name,last_name,profile_pic&access_token=${token}`)
        ...
        axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/idln/${text}`)
         .then(function (response) {
           const data= response.status
           console.log(response);
         })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/ID/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/link/${sender}/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/otp/${sender}/${text}`)
        .then(function (response) {
          const data= response.status
     ...
     /*else if(text.includes("load")){
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/balance/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       /*axios.get(`http://3a72fe37.ngrok.io/api/balance/${sender}`)
        .then(function (response) {
          console.log(response);
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/final/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/balanceco/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/mini1/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/deposit/${text}`)
        .then(function (response) {
          console.log(response);
          console.log("This is me",phoneNumber);
        })
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/phone/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
      ...
      let  phoneNumber = text
       ...
       axios.get(`http://3a72fe37.ngrok.io/api/push/${sender}/amount/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
      ...
      let  phoneNumber = text
       ...
       quickReplyAcc(sender)
             ...
             axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/tranfer/${text}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
              })
             ...
             axios.get(`http://3a72fe37.ngrok.io/api/otp/${sender}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
              })
            ...
            //let service = "loc"
            axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/location/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
        ...
        //    the yes no for account opening
          ...
          sendButtonGen(sender,"This are general services available")
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/chequestatus/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/email/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
        ...
        //  sendText(sender,"Great welcome to national bank")
          ...
          sendQuickRead(sender , "Great welcome to national bank, there are afew items you will require on hand, Your National ID and make sure your MPESA has atleast Kshs 100.00, cofirm when ready ")
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/idreg/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            //the id Number
             ...
             axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/reg2/${text}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/register/${sender}/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/push1/${sender}`)
             .then(function (response) {
               const data= response.status
               sendQuickDep(sender)
               console.log(response);
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/more100/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
           })
            ...
            axios.get(`http://3a72fe37.ngrok.io/api/otp/${sender}/${text}`)
                ...
                // sendQuickDep(sender)
                     axios.get(`http://3a72fe37.ngrok.io/api/push1/${sender}`)
                      .then(function (response) {
                        ...
                        axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/reg3/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                       })
             ...
             .catch(function (error) {
              ...
              axios.get(`http://3a72fe37.ngrok.io/api/pastmessage/${sender}`)
               .then(function (response) {
                 const data= response.status
                 console.log(response);
                 ...
                 //reg part 2
                   ...
                   axios.get(`http://3a72fe37.ngrok.io/api/register/${sender}/${text}`)
                    .then(function (response) {
                      const data= response.status
                      console.log(response);
                      axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/otpreg/${text}`)
                       .then(function (response) {
                         const data= response.status
                         console.log(response);
                       })
                   ...
                   //for the otp confirmation
                     ...
                     axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/ID/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/phonelink/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                         })
                     ...
                     axios.get(`http://3a72fe37.ngrok.io/api/ministatement/${sender}`)
                      .then(function (response) {
                        console.log(response);
                     ...
                     axios.get(`http://3a72fe37.ngrok.io/api/link/${sender}/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/otplink/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                         })
                     ...
                     axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/balanceco1/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                      })
                     ...
                     if( text === 'yes'){
                       ...
                       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/chequeLocation/${text}`)
                        .then(function (response) {
                          const data= response.status
                          console.log(response);
                        })
                     ...
                     if(text === 'yes'){
                       ...
                       axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/emailfinal/${text}`)
                        .then(function (response) {
                          const data= response.status
                          console.log(response);
                        })
                    ...
                    let  phoneNumber = text
                     ...
                     axios.get(`http://3a72fe37.ngrok.io/api/push2/${sender}/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://3a72fe37.ngrok.io/api/postmessage/${sender}/final/${text}`)
