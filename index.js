...
//Kunta  let token = "EAADUxvcXkUUBAKynDiAdz4l47j9uJupmbqXQ05ZAfCexmYtAoZC3W1YYuJMnxgryLcvu3tEaIZBYeZAU0hYmGV8lEGeeiXRGvSPvKQ0RxOMGZBQJZBtKiZCpFpjbtiVerJFQVYivtGfTuek3h5cSEEpCif3ZBLmfItw6OEe6x12RpPNoiomlMZAmO"
...
function decideMessage(sender, text1){
    ...
    let service = text
     if(text.includes("get started")){
       ...
       axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/ID/${text}`)
        .then(function (response) {
          const data= response.status
          console.log(response);
        })
     ...
     /*else if(text.includes("load")){
      ...
      let  phoneNumber = text
       ...
       quickReplyAcc(sender)
             ...
             axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/tranfer/${text}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
              })
             ...
             axios.get(`http://7e3210e2.ngrok.io/api/otp/${sender}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
              })
            ...
            //let service = "loc"
            axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/location/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
        ...
        //    the yes no for account opening
          ...
          sendButtonGen(sender,"This are general services available")
            ...
            axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/chequestatus/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/email/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
        ...
        //  sendText(sender,"Great welcome to national bank")
          ...
          sendQuickRead(sender , "Great welcome to national bank, there are afew items you will require on hand, Your National ID and make sure your MPESA has atleast Kshs 100.00, cofirm when ready")
            ...
            axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/idreg/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            //the id Number
             ...
             axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/reg2/${text}`)
              .then(function (response) {
                const data= response.status
                console.log(response);
            ...
            axios.get(`http://7e3210e2.ngrok.io/api/register/${sender}/${text}`)
             .then(function (response) {
               const data= response.status
               console.log(response);
             })
            ...
            axios.get(`http://7e3210e2.ngrok.io/api/otp/${sender}/${text}`)
                ...
                // sendQuickDep(sender)
                     axios.get(`http://7e3210e2.ngrok.io/api/push1/${sender}`)
                      .then(function (response) {
                        ...
                        axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/reg3/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                       })
             ...
             .catch(function (error) {
              ...
              axios.get(`http://7e3210e2.ngrok.io/api/pastmessage/${sender}`)
               .then(function (response) {
                 const data= response.status
                 console.log(response);
                 ...
                 //reg part 2
                   ...
                   axios.get(`http://7e3210e2.ngrok.io/api/register/${sender}/${text}`)
                    .then(function (response) {
                      const data= response.status
                      console.log(response);
                      axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/otpreg/${text}`)
                       .then(function (response) {
                         const data= response.status
                         console.log(response);
                       })
                   ...
                   //for the otp confirmation
                     ...
                     axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/ID/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/phonelink/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                         })
                     ...
                     axios.get(`http://7e3210e2.ngrok.io/api/link/${sender}/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/otplink/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
                         })
                     ...
                     if( text === 'yes'){
                       ...
                       axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/chequeLocation/${text}`)
                        .then(function (response) {
                          const data= response.status
                          console.log(response);
                        })
                     ...
                     if(text === 'yes'){
                       ...
                       axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/emailfinal/${text}`)
                        .then(function (response) {
                          const data= response.status
                          console.log(response);
                        })
                     ...
                     axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/phone/${text}`)
                      .then(function (response) {
                        const data= response.status
                        console.log(response);
                        axios.get(`http://7e3210e2.ngrok.io/api/postmessage/${sender}/amountdepo/${text}`)
                         .then(function (response) {
                           const data= response.status
                           console.log(response);
